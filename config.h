...
// =================================================================
const long CALIBRATION_DURATION_MS = 60000; 
const long FINISHED_TIMEOUT_MS = 300000;
const float PATTERN_MATCH_TOLERANCE = 0.35; 
const float MIN_WASH_THRESHOLD = 2.0;
const float MIN_SPIN_THRESHOLD = 10.0;
